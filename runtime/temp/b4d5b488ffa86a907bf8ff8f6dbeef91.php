<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"/www/wwwroot/ywscs.com/public/../application/admin/view/seckill/lst.html";i:1634716848;s:67:"/www/wwwroot/ywscs.com/application/admin/view/seckill/ajaxpage.html";i:1634716462;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
var url = "/<?php echo \think\Request::instance()->module(); ?>/seckill";
var deleteUrl = "<?php echo url('seckill/delete'); ?>";
</script>
...
<body class="gray-bg">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="col-sm-5 m-b-xs">                    
                               ...
                               <a href="<?php echo url('seckill/lst',array('filter'=>5)); ?>"><div class="qiehuan" <?php if($filter && $filter == 5): ?>style="background-color: #1992FC;color: #FFF;"<?php endif; ?>>全部</div></a>
                               <a href="<?php echo url('seckill/lst',array('filter'=>1)); ?>"><div class="qiehuan" <?php if($filter && $filter == 1): ?>style="background-color: #1992FC;color: #FFF;"<?php endif; ?>>即将开始</div></a>
                               <a href="<?php echo url('seckill/lst',array('filter'=>2)); ?>"><div class="qiehuan" <?php if($filter && $filter == 2): ?>style="background-color: #1992FC;color: #FFF;"<?php endif; ?>>秒杀中</div></a>
                               <a href="<?php echo url('seckill/lst',array('filter'=>3)); ?>"><div class="qiehuan" <?php if($filter && $filter == 3): ?>style="background-color: #1992FC;color: #FFF;"<?php endif; ?>>已结束</div></a>
                               </div>
                        </div> 
                        </div>
						...
						<div class="row">
						    ...
						    <a href="<?php echo url('seckill/add'); ?>"><button type="button" class="btn btn-sm btn-primary" id="add" style="margin-right:15px;"><i class="fa fa-plus" style="color:#FFF;"></i>&nbsp;新增秒杀活动</button></a>
                            </div>  
                            
                            <div class="col-sm-10 m-b-xs" style="float:right;">
                            <form action="<?php echo url('seckill/search'); ?>" method="post" id="form_search" style="margin-top:10px;">
                            ...
                            <div style="float:right; font-size:15px; margin-right:10px;">
                                <select style="height:30px; line-height:30px; border:1px solid #e5e6e7;" name="checked">
                                    ...
                                    <option value="1" <?php if((isset($checked)) AND ($checked == 1)): ?>selected="selected"<?php endif; ?>>即将开始</option>
                                    <option value="2" <?php if((isset($checked)) AND ($checked == 2)): ?>selected="selected"<?php endif; ?>>秒杀中</option>
                                    <option value="3" <?php if((isset($checked)) AND ($checked == 3)): ?>selected="selected"<?php endif; ?>>已结束</option>
                                </select>
                            </div>                           
	...
	var search = 0;
	var goUrl = "/<?php echo \think\Request::instance()->module(); ?>/seckill/lst/filter/"+filter+".html?page="+pnum;
	<?php else: ?>
	var search = <?php echo $search; ?>;
	var goUrl = "/<?php echo \think\Request::instance()->module(); ?>/seckill/search.html?page="+pnum;
	<?php endif; ?>
</script>    
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <?php if(!empty($list)): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$v): ?>
                                <tr>
                                    ...
                                    <td>起：<?php echo date('Y-m-d H:i:s',$v['start_time']); ?><br>止：<?php echo date('Y-m-d H:i:s',$v['end_time']); ?></td>
