<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/www/wwwroot/ywscs.com/public/../application/admin/view/shop_assemble/lst.html";i:1618769683;s:73:"/www/wwwroot/ywscs.com/application/admin/view/shop_assemble/ajaxpage.html";i:1618769683;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
var url = "/<?php echo \think\Request::instance()->module(); ?>/shop_assemble";
</script>
...
<body class="gray-bg">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="col-sm-5 m-b-xs">                    
                               ...
                               <a href="<?php echo url('shop_assemble/lst',array('filter'=>10)); ?>"><div class="qiehuan" <?php if($filter && $filter == 10): ?>style="background-color: #1992FC;color: #FFF;"<?php endif; ?>>全部</div></a>
                               <a href="<?php echo url('shop_assemble/lst',array('filter'=>1)); ?>"><div class="qiehuan" <?php if($filter && $filter == 1): ?>style="background-color: #1992FC;color: #FFF;"<?php endif; ?>>待审核</div></a>
                               <a href="<?php echo url('shop_assemble/lst',array('filter'=>2)); ?>"><div class="qiehuan" <?php if($filter && $filter == 2): ?>style="background-color: #1992FC;color: #FFF;"<?php endif; ?>>即将开始</div></a>         
                               <a href="<?php echo url('shop_assemble/lst',array('filter'=>3)); ?>"><div class="qiehuan" <?php if($filter && $filter == 3): ?>style="background-color: #1992FC;color: #FFF;"<?php endif; ?>>拼团中</div></a> 
                               <a href="<?php echo url('shop_assemble/lst',array('filter'=>4)); ?>"><div class="qiehuan" <?php if($filter && $filter == 4): ?>style="background-color: #1992FC;color: #FFF;"<?php endif; ?>>已结束</div></a> 
                               <a href="<?php echo url('shop_assemble/lst',array('filter'=>5)); ?>"><div class="qiehuan" <?php if($filter && $filter == 5): ?>style="background-color: #1992FC;color: #FFF;"<?php endif; ?>>平台关闭</div></a> 
                               </div>
                        </div> 
                        </div>
						...
						<div class="row">
                            ...
                            <form action="<?php echo url('shop_assemble/search'); ?>" method="post" id="form_search" style="margin-top:10px;">
                            ...
                            <div style="float:right; font-size:15px; margin-right:10px;">
                                <select style="height:30px; line-height:30px; border:1px solid #e5e6e7;" name="checked">
                                    ...
                                    <option value="3" <?php if((isset($checked)) AND ($checked == 3)): ?>selected="selected"<?php endif; ?>>拼团中</option>
	...
	var search = 0;
	var goUrl = "/<?php echo \think\Request::instance()->module(); ?>/shop_assemble/lst/filter/"+filter+".html?page="+pnum;
	<?php else: ?>
	var search = <?php echo $search; ?>;
	var goUrl = "/<?php echo \think\Request::instance()->module(); ?>/shop_assemble/search.html?page="+pnum;
	<?php endif; ?>
</script>    
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <?php if(!empty($list)): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$v): ?>
                                <tr>
                                    ...
                                    <td>                                  
                                    <?php if($v['checked'] == 0): ?><button type="button" class="btn btn-primary btn-xs" onclick="pin_checked(<?php echo $v['id']; ?>,this);"><i class="fa fa-pencil"></i>&nbsp;审核</button><?php else: ?><button type="button" class="btn btn-info btn-xs" onclick="pin_info(<?php echo $v['id']; ?>,this);"><i class="fa fa-paste"></i>&nbsp;详细</button><?php endif; ?>
                                    </td>
                                </tr>
