<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"/www/wwwroot/ywscs.com/public/../application/admin/view/version/lst.html";i:1635844179;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
var url = "/<?php echo \think\Request::instance()->module(); ?>/version";
var deleteUrl = "<?php echo url('version/delete'); ?>";
</script>
                    ...
                    <div class="ibox-content">
						<div class="row">
						   <div class="col-sm-8 m-b-xs">
                                <a href="<?php echo url('version/add'); ?>"><button type="button" class="btn btn-sm btn-primary" id="add" style="margin-right:15px;"><i class="fa fa-plus" style="color:#FFF;"></i>&nbsp;增加版本</button></a>
                            </div>
                        ...
                        <table id="sort" class="table table-hover table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width:10%">更新内容</th>
                                    <th style="width:10%">更新方式</th>
                                    <th style="width:20%">安卓地址</th>
                                    <th style="width:20%">iOS地址</th>
                            ...
                            <?php if(!empty($list)): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$v): ?>
                                <tr>
                                    ...
                                    <td><?php echo $v['version_info']; ?></td>
                                    <td><?php echo $v['update_type']; ?></td>
