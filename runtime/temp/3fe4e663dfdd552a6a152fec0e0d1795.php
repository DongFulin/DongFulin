<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"/www/wwwroot/ywscs.com/public/../application/admin/view/message/lst.html";i:1618769683;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
var url = "/<?php echo \think\Request::instance()->module(); ?>/message";
var deleteUrl = "<?php echo url('message/delete'); ?>";
</script>
                    ...
                    <div class="ibox-content">
						<div class="row">
						   <div class="col-sm-8 m-b-xs">
                                <a href="<?php echo url('message/send'); ?>"><button type="button" class="btn btn-sm btn-primary" id="add" style="margin-right:15px;"><i class="fa fa-plus" style="color:#FFF;"></i>&nbsp;发送消息</button></a>
                        ...
                        <table id="sort" class="table table-hover table-bordered">
                            ...
                            <?php if(!empty($list)): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$v): ?>
                                <tr>
                                    ...
                                    <th><?php if($v['type'] == 0): ?>平台通知<?php else: ?>专属私信<?php endif; ?>:<?php if($v['user_id'] == 0): ?>平台所有人<?php else: ?><?php echo $v['user_name']; endif; ?></th>
                                    <td><?php echo date('Y-m-d H:i:s',$v['create_time']); ?></td>
									<td><?php echo date('Y-m-d H:i:s',$v['edit_time']); ?></td>
