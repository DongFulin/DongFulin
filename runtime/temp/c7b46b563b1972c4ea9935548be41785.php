<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"/www/wwwroot/ywscs.com/public/../application/admin/view/sertion/lst.html";i:1640885532;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
var url = "/<?php echo \think\Request::instance()->module(); ?>/sertion";
var deleteUrl = "<?php echo url('sertion/delete'); ?>";
</script>
  ...
  $(document).ready(function(){
      var fixHelperModified = function(e, tr) {
       ...
       updateIndex = function(e, ui) {
	       ...
	       $.ajax({
	           type:'POST',
	           url:"<?php echo url('sertion/paixu'); ?>",
                    ...
                    <div class="ibox-content">
						<div class="row">
						   <div class="col-sm-8 m-b-xs">
                                <a href="<?php echo url('sertion/add'); ?>"><button type="button" class="btn btn-sm btn-primary" id="add" style="margin-right:15px;"><i class="fa fa-plus" style="color:#FFF;"></i>&nbsp;增加服务项</button></a>         
                            </div>              
