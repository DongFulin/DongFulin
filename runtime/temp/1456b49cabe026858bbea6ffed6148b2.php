<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"/www/wwwroot/ywscs.com/public/../application/admin/view/comment/lst.html";i:1618769683;s:67:"/www/wwwroot/ywscs.com/application/admin/view/comment/ajaxpage.html";i:1635221444;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
//删除url
var deleteUrl = "<?php echo url('comment/delete'); ?>";
var url = "/<?php echo \think\Request::instance()->module(); ?>/comment";
</script>
...
<body class="gray-bg" >
                    ...
                    <div class="ibox-content">
						...
						<div class="row" style="margin-top:15px;">
						  	<div class="col-sm-4 m-b-xs">
                               ...
                               <a href="<?php echo url('comment/lst',array('filter'=>3)); ?>"><div class="qiehuan" <?php if((isset($filter)) AND ($filter == 3)): ?>style="background-color: #1992FC;color: #FFF;"<?php endif; ?>>全部</div></a>
                               <a href="<?php echo url('comment/lst',array('filter'=>1)); ?>"><div class="qiehuan" <?php if((isset($filter)) AND ($filter == 1)): ?>style="background-color: #1992FC;color: #FFF;"<?php endif; ?>>正常</div></a>
                               <a href="<?php echo url('comment/lst',array('filter'=>2)); ?>"><div class="qiehuan" <?php if((isset($filter)) AND ($filter == 2)): ?>style="background-color: #1992FC;color: #FFF;"<?php endif; ?>>违规</div></a>
                               </div>
                            </div>


						    <div class="col-sm-8 m-b-xs" style="float:right; margin-top:25px;">
                            <form action="<?php echo url('comment/search'); ?>" method="post" id="form_search">
	...
	var search = 0;
	var goUrl = "/<?php echo \think\Request::instance()->module(); ?>/comment/lst/filter/"+filter+".html?page="+pnum;
	<?php else: ?>
	var search = <?php echo $search; ?>;
	var goUrl = "/<?php echo \think\Request::instance()->module(); ?>/comment/search.html?page="+pnum;
	<?php endif; ?>
</script>
