<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"/www/wwwroot/ywscs.com/public/../application/admin/view/nav_menu/edit.html";i:1645689132;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    ...
    var url = "/<?php echo \think\Request::instance()->module(); ?>/nav_menu/navlist/nav_id/"+nav_id+".html?page="+pnum;
    var updateUrl = "<?php echo url('nav_menu/edit'); ?>";
</script>
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" id="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="menu_name" value="<?php echo $menus['menu_name']; ?>" class="form-control">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="img-box">
                                        <img id="icon_image" src="<?php echo $menus['image_path']; ?>" onerror="this.src='/static/admin/img/nopic.jpg'" width="100" height="100" />
                                    </div>
                                    <div id="uploadIconImage"></div>
                                </div>
                                <input type="hidden" name="image_path" value="<?php echo $menus['image_path']; ?>">
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="menu_url" value="<?php echo $menus['menu_url']; ?>" class="form-control">
                                </div>
                                <label class="col-sm-1" style="padding-top:7px; color:#F00; font-size:16px;">*</label>
                            </div>						
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group hidden">
                                ...
                                <div class="col-sm-6" id="atype">
                                    <label class="radio-inline"><input type="radio" name="url_type" <?php if($menus['url_type'] == 1): ?>checked="checked"<?php endif; ?> value="1">内部跳转</label>
                                    <label class="radio-inline"><input type="radio" name="url_type" <?php if($menus['url_type'] == 2): ?>checked="checked"<?php endif; ?> value="2">外部跳转</label>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6" id="atype">
                                    <label class="radio-inline"><input type="radio" name="is_show" <?php if($menus['is_show'] == 1): ?>checked="checked"<?php endif; ?> value="1">是</label>
                                    <label class="radio-inline"><input type="radio" name="is_show" <?php if($menus['is_show'] == 0): ?>checked="checked"<?php endif; ?> value="0">否</label>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="sort" value="<?php echo $menus['sort']; ?>" class="form-control">
                                </div>
                                <label class="col-sm-1" style="padding-top:7px; color:#F00; font-size:16px;">*</label>
                            </div>						
                            <div class="hr-line-dashed"></div>  
