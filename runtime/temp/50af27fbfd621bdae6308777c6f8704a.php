<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"/www/wwwroot/ywscs.com/public/../application/admin/view/new_publish/lst.html";i:1618769683;s:71:"/www/wwwroot/ywscs.com/application/admin/view/new_publish/ajaxpage.html";i:1618769683;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    var deleteUrl = "<?php echo url('NewPublish/delete'); ?>";
</script>
                    ...
                    <div class="ibox-content">
                        <div class="row" style="margin-top:10px;margin-bottom:10px;">
                            <div class="col-sm-3 m-b-xs">
                                <a href="<?php echo url('NewPublish/add'); ?>" class="btn btn-sm btn-primary"><i class="fa fa-plus" style="color:#FFF;"></i>&nbsp;新品发布</a>
                            </div>
                            
                            <form action="<?php echo url('NewPublish/lst'); ?>" method="post">
                            <div class="col-sm-3" style="float:right;">
                                <div class="input-group">
                                    <input type="text" name="keyword" placeholder="请输入店铺名称" value="<?php echo $keyword; ?>" class="input-sm form-control">
...
<!--            <td><?php echo $v['praise_num']; ?></td>
            ...
            <td>
                <a href="<?php echo url('NewPublish/edit',array('id'=>$v['id'])); ?>" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i>&nbsp;编辑</a>&nbsp;&nbsp;&nbsp;&nbsp;
...
<div class="row"><div class="pagination" style="float:right; margin-right:20px;"><?php echo $page; ?></div></div>
    ...
    <script type="text/javascript">
        ...
        function changeTableVal(id, status) {
            $.ajax({
                url:"<?php echo url('NewPublish/changeStatus'); ?>",
                type:'POST',
        ...
        function cl(){
            location.href = "<?php echo url('NewPublish/lst'); ?>";
        }
    </script>
