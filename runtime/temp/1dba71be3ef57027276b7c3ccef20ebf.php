<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"/www/wwwroot/ywscs.com/public/../application/admin/view/shop_thapply/lst.html";i:1618769683;s:72:"/www/wwwroot/ywscs.com/application/admin/view/shop_thapply/ajaxpage.html";i:1618769683;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
var url = "/<?php echo \think\Request::instance()->module(); ?>/shop_thapply";
</script>
...
<body class="gray-bg" >
                    ...
                    <div class="ibox-content">
                        <div class="row">
						   <div class="col-sm-5 m-b-xs">                    
                               ...
                               <a href="<?php echo url('shop_thapply/lst',array('filter'=>10)); ?>"><div class="qiehuan" <?php if($filter && $filter == 10): ?>style="background-color: #1992FC;color: #FFF;"<?php endif; ?>>全部</div></a>
                               <a href="<?php echo url('shop_thapply/lst',array('filter'=>1)); ?>"><div class="qiehuan" <?php if($filter && $filter == 1): ?>style="background-color: #1992FC;color: #FFF;"<?php endif; ?>>待审核</div></a>
                               <a href="<?php echo url('shop_thapply/lst',array('filter'=>2)); ?>"><div class="qiehuan" <?php if($filter && $filter == 2): ?>style="background-color: #1992FC;color: #FFF;"<?php endif; ?>>售后中</div></a>
                               <a href="<?php echo url('shop_thapply/lst',array('filter'=>3)); ?>"><div class="qiehuan" <?php if($filter && $filter == 3): ?>style="background-color: #1992FC;color: #FFF;"<?php endif; ?>>已拒绝</div></a>
                               <a href="<?php echo url('shop_thapply/lst',array('filter'=>5)); ?>"><div class="qiehuan" <?php if($filter && $filter == 5): ?>style="background-color: #1992FC;color: #FFF;"<?php endif; ?>>已完成</div></a>
                               <a href="<?php echo url('shop_thapply/lst',array('filter'=>4)); ?>"><div class="qiehuan" <?php if($filter && $filter == 4): ?>style="background-color: #1992FC;color: #FFF;"<?php endif; ?>>用户已撤销</div></a>
                               </div>
                            </div>                                                                                             
                        </div>
                        
						<div class="row" style="margin-top:15px;">
                            <form action="<?php echo url('shop_thapply/search'); ?>" method="post" id="form_search">          
	...
	var search = 0;
	var goUrl = "/<?php echo \think\Request::instance()->module(); ?>/shop_thapply/lst/filter/"+filter+".html?page="+pnum;
	<?php else: ?>
	var search = <?php echo $search; ?>;
	var goUrl = "/<?php echo \think\Request::instance()->module(); ?>/shop_thapply/search.html?page="+pnum;
	<?php endif; ?>
</script> 
