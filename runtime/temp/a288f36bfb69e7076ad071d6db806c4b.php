<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"/www/wwwroot/ywscs.com/public/../application/admin/view/promotion/lst.html";i:1618769683;s:69:"/www/wwwroot/ywscs.com/application/admin/view/promotion/ajaxpage.html";i:1628740418;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
var url = "/<?php echo \think\Request::instance()->module(); ?>/promotion";
var deleteUrl = "<?php echo url('promotion/delete'); ?>";
</script>
...
<body class="gray-bg">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="col-sm-5 m-b-xs">                    
                               ...
                               <a href="<?php echo url('promotion/lst',array('filter'=>5)); ?>"><div class="qiehuan" <?php if($filter && $filter == 5): ?>style="background-color: #1992FC;color: #FFF;"<?php endif; ?>>全部</div></a>
                               <a href="<?php echo url('promotion/lst',array('filter'=>1)); ?>"><div class="qiehuan" <?php if($filter && $filter == 1): ?>style="background-color: #1992FC;color: #FFF;"<?php endif; ?>>即将开始</div></a>         
                               <a href="<?php echo url('promotion/lst',array('filter'=>2)); ?>"><div class="qiehuan" <?php if($filter && $filter == 2): ?>style="background-color: #1992FC;color: #FFF;"<?php endif; ?>>活动中</div></a> 
                               <a href="<?php echo url('promotion/lst',array('filter'=>3)); ?>"><div class="qiehuan" <?php if($filter && $filter == 3): ?>style="background-color: #1992FC;color: #FFF;"<?php endif; ?>>已结束</div></a>    
                               </div>
                        </div> 
                        </div>
						...
						<div class="row">
						    ...
						    <a href="<?php echo url('promotion/add'); ?>"><button type="button" class="btn btn-sm btn-primary" id="add" style="margin-right:15px;"><i class="fa fa-plus" style="color:#FFF;"></i>&nbsp;新增促销活动</button></a>                  
                            </div>  
                            
                            <div class="col-sm-10 m-b-xs" style="float:right;">
                            <form action="<?php echo url('promotion/search'); ?>" method="post" id="form_search" style="margin-top:10px;">
	...
	var search = 0;
	var goUrl = "/<?php echo \think\Request::instance()->module(); ?>/promotion/lst/filter/"+filter+".html?page="+pnum;
	<?php else: ?>
	var search = <?php echo $search; ?>;
	var goUrl = "/<?php echo \think\Request::instance()->module(); ?>/promotion/search.html?page="+pnum;
	<?php endif; ?>
</script>    
