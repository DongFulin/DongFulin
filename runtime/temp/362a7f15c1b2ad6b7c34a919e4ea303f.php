<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"/www/wwwroot/ywscs.com/public/../application/admin/view/cation/lst.html";i:1639730035;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
var url = "/<?php echo \think\Request::instance()->module(); ?>/cation";
var deleteUrl = "<?php echo url('cation/delete'); ?>";
</script>
                    ...
                    <div class="ibox-content">
						<div class="row">
						   <div class="col-sm-8 m-b-xs">
                                <a href="<?php echo url('cation/add'); ?>"><button type="button" class="btn btn-sm btn-primary" id="add"><i class="fa fa-plus" style="color:#FFF;"></i>&nbsp;增加分类配置</button></a>
                            </div>              
