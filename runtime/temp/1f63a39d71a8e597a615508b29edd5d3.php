<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"/www/wwwroot/ywscs.com/public/../application/admin/view/news/add.html";i:1618769683;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
var url = "<?php echo url('news/lst'); ?>";
<?php else: ?>
var cate_id = <?php echo $cate_id; ?>;
var url = "/<?php echo \think\Request::instance()->module(); ?>/news/catelist/cate_id/"+cate_id;
<?php endif; ?>
var insertUrl = "<?php echo url('news/add'); ?>";
</script>
                        ...
                        <form method="post" enctype="multipart/form-data" class="form-horizontal" id="form">
                           ...
                           <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <option value="">请选择</option>
                                        ...
                                        <option value="<?php echo $v['id']; ?>" <?php if($v['pid'] == '0'): ?>style="font-weight:bold;"<?php endif; if((isset($cate_id)) && ($cate_id == $v['id'])): ?>selected = "selected"<?php endif; ?>><?php echo str_repeat('&nbsp;&nbsp;&nbsp;&nbsp;', $v['level']); if($v['level'] > '0'): ?>|<?php endif; ?><?php echo $v['html']; ?><?php echo $v['cate_name']; ?></option>
                            ...
                            <img id="image" src="/static/admin/img/nopic.jpg" width="180" height="120" border="0" />
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="ar_content" name="ar_content"></textarea>
                                </div>  
                            </div>
                            <div class="hr-line-dashed"></div>
