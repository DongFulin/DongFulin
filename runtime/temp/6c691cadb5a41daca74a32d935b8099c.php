<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"/www/wwwroot/ywscs.com/public/../application/admin/view/order/lst.html";i:1645834385;s:65:"/www/wwwroot/ywscs.com/application/admin/view/order/ajaxpage.html";i:1645834385;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
//删除url
var deleteUrl = "<?php echo url('order/delete'); ?>";
var url = "/<?php echo \think\Request::instance()->module(); ?>/order";
</script>
...
<body class="gray-bg" >
                    ...
                    <div class="ibox-content">
                        <div class="row">
						   <div class="col-sm-5 m-b-xs">                    
                               ...
                               <a href="<?php echo url('order/lst',array('filter'=>10)); ?>"><div class="qiehuan" <?php if($filter && $filter == 10): ?>style="background-color: #1992FC;color: #FFF;"<?php endif; ?>>全部</div></a>
                               <a href="<?php echo url('order/lst',array('filter'=>1)); ?>"><div class="qiehuan" <?php if($filter && $filter == 1): ?>style="background-color: #1992FC;color: #FFF;"<?php endif; ?>>待发货</div></a>
                               <a href="<?php echo url('order/lst',array('filter'=>2)); ?>"><div class="qiehuan" <?php if($filter && $filter == 2): ?>style="background-color: #1992FC;color: #FFF;"<?php endif; ?>>已发货</div></a>
                               <a href="<?php echo url('order/lst',array('filter'=>3)); ?>"><div class="qiehuan" <?php if($filter && $filter == 3): ?>style="background-color: #1992FC;color: #FFF;"<?php endif; ?>>已完成</div></a>
                               <a href="<?php echo url('order/lst',array('filter'=>4)); ?>"><div class="qiehuan" <?php if($filter && $filter == 4): ?>style="background-color: #1992FC;color: #FFF;"<?php endif; ?>>待支付</div></a>
                               <a href="<?php echo url('order/lst',array('filter'=>6)); ?>"><div class="qiehuan" <?php if($filter && $filter == 6): ?>style="background-color: #1992FC;color: #FFF;"<?php endif; ?>>已取消</div></a>
                               <a href="<?php echo url('order/lst',array('filter'=>5)); ?>"><div class="qiehuan" <?php if($filter && $filter == 5): ?>style="background-color: #1992FC;color: #FFF;"<?php endif; ?>>已关闭</div></a>
                               </div>
                            </div>                                                                                             
                        </div>
                        
						<div class="row" style="margin-top:15px;">
                            <form action="<?php echo url('order/search'); ?>" method="post" id="form_search">          
                            ...
                            <div style="float:right; font-size:15px; margin-right:10px;">
                                <select style="height:30px; line-height:30px; border:1px solid #e5e6e7;" name="zf_type">
                                    ...
                                    <option value="5" <?php if(isset($zf_type) && $zf_type == 5): ?>selected="selected"<?php endif; ?>>银行卡支付</option>
                                </select>
                            </div>
                            ...
                            <div style="float:right; font-size:15px; margin-right:10px;">
                                <select style="height:30px; line-height:30px; border:1px solid #e5e6e7;" name="order_zt">
                                    ...
                                    <option value="6" <?php if(isset($order_zt) && $order_zt == 6): ?>selected="selected"<?php endif; ?>>已取消</option>
	...
	var search = 0;
	var goUrl = "/<?php echo \think\Request::instance()->module(); ?>/order/lst/filter/"+filter+".html?page="+pnum;
	<?php else: ?>
	var search = <?php echo $search; ?>;
	var goUrl = "/<?php echo \think\Request::instance()->module(); ?>/order/search.html?page="+pnum;
	<?php endif; ?>
</script> 
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <?php if($list->isEmpty() == false): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$v): ?> 
                                <tr>
                                    ...
                                    <font <?php if(($v['user_dakuan_status'] == 1 && $v['state'] == 1) || $v['state'] == 0): ?>style="color:#F00;" <?php else: ?> style="color:#FFDD55;" <?php endif; ?>>已取消</font>
                                    <?php endif; ?>
                                    </td>
