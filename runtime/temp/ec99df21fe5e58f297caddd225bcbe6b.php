<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"/www/wwwroot/ywscs.com/public/../application/admin/view/category/lst.html";i:1618769683;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
var url = "/<?php echo \think\Request::instance()->module(); ?>/category";
var deleteUrl = "<?php echo url('category/delete'); ?>";
var sortUrl = "<?php echo url('category/order'); ?>";
</script>
                    ...
                    <div class="ibox-content">
						<div class="row">
						   <div class="col-sm-8 m-b-xs">
                                <a href="<?php echo url('category/add'); ?>"><button type="button" class="btn btn-sm btn-primary" id="add" style="margin-right:15px;"><i class="fa fa-plus" style="color:#FFF;"></i>&nbsp;增加分类</button></a>
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <?php if($list): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$v): ?>
                                <tr cid="<?php echo $v['id']; ?>" pid="<?php echo $v['pid']; ?>" level="<?php echo $v['level']; ?>" <?php if($v['pid'] != 0): ?>style="display:none;"<?php endif; ?>>
                                    ...
                                    <td><a style="color:#676a6c;" href="<?php echo url('goods/catelist',array('cate_id'=>$v['id'])); ?>"><?php echo str_repeat('&nbsp;&nbsp;&nbsp;&nbsp;', $v['level']); if($v["level"] > 0): ?>|<?php endif; ?><?php echo $v['html']; if($v["pid"] == 0): ?><b><?php echo $v['cate_name']; ?></b><?php else: ?><?php echo $v['cate_name']; endif; ?></a></td>
                                    <td><?php echo $v['id']; ?></td>
                                    <td>
                                    <?php if($v['is_show'] == 1): ?>
                                    ...
                                    <td>
                                    <?php if($v['show_in_recommend'] == 1): ?>
                                    <button class="btn btn-primary btn-xs" type="button" onclick="changeTableVal(<?php echo $v['id']; ?>,'show_in_recommend',this);"><i class="fa fa-check"></i></button>
                                    <?php elseif($v['show_in_recommend'] == 0): ?>
                                    <button class="btn btn-danger btn-xs" type="button" onclick="changeTableVal(<?php echo $v['id']; ?>,'show_in_recommend',this);"><i class="fa fa-times"></i></button>
                                    <?php endif; ?>
                                    </td>
                                    <td><input name="<?php echo $v['id']; ?>" type="text" value="<?php echo $v['sort']; ?>" class="sort" size="4"></td>
