...
class Rzmessage extends Common
{
    public function info(){
        ...
        if($applys){
             $rz_orders = Db::name('rz_order')->alias('a')->field('a.*,b.industry_name,b.ser_price,b.remind')->join('sp_industry b','a.indus_id = b.id','LEFT')->where('a.apply_id',$applys['id'])->find();
            // if($rz_orders){
