...
class Getgoods extends Common{
    ...
    public function lst(){
        ...
        $list = Db::name('goods')->alias('a')->field('a.id,a.goods_name,a.thumb_url,a.shop_price,b.shop_name,c.cate_name')->join('sp_shops b','a.shop_id = b.id','LEFT')->join('sp_category c','a.cate_id = c.id','LEFT')->where($where)->order('a.addtime desc')->paginate(10);
        $page = $list->render();
