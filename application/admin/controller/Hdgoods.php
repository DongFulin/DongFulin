...
class Hdgoods extends Common{
    ...
    public function lst(){
        ...
        $list = Db::name('goods')->alias('a')->field('a.id,a.goods_name,a.thumb_url,a.shop_price,b.cate_name')->join('sp_category b','a.cate_id = b.id','LEFT')->where($where)->order('a.addtime desc')->paginate(10);
        $page = $list->render();
