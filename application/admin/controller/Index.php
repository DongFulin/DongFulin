...
class Index extends Common
{
    ...
    public function dashboard(){
        ...
        $month_tuinum = Db::name('order_goods')->alias('a')->join('sp_order b','a.order_id = b.id','INNER')->where('a.th_status','in','1,2,3,4')->where('b.state',1)->where('b.addtime','egt',$nowmonth)->where('b.addtime','lt',$lastyear)->count();
