...
class NewPublish extends Common{
    ...
    public function lst() {
        ...
        foreach ($list as $key => $item) {
            ...
            foreach ($video_list as $v) {
                $video_url = $cos_domain . $v['video_path'];
                 $vide_path_str .= "<a href='{$video_url}' target='_bank'>..." . $v['video_path'] . '</a><br>';
            }
    ...
    public function edit() {
        ...
        foreach ($video_list as $key => $v) {
            $video_list[$key]['cover_img'] = $this->webconfig['cos_domain'] . $v['cover_img'];
            $video_list[$key]['video_url'] = $this->webconfig['cos_domain'] . $v['video_path'];
        }
        $data = array(
            'info' => $info,
            'shop_list' => $shop_list,
