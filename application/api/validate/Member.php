...
class Member extends Validate
{
    ...
    protected $message = [
        ...
        'password.regex' => '密码为6-10位字母或数字1',
        'repwd.requireWith' => '确认密码不能为空',
        'repwd.confirm' => '确认密码不正确',
        'repwd.regex' => '密码为6-10位字母或数字2',
    ...
    protected $scene = [
        ...
        'pwd_login' => ['phone' => 'require|regex:/^1[3456789]\d{9}$/','password'],
        'sms_login' => ['phone' => 'require|regex:/^1[3456789]\d{9}$/'],
        ...
        'find_back_pwd' => ['phone' => 'require|regex:/^1[3456789]\d{9}$/','password','phonecode'],
        'edit_pwd' => ['phone' => 'require|regex:/^1[3456789]\d{9}$/','password','phonecode'],
        'set_pay_pwd' => ['phone' => 'require|regex:/^1[3456789]\d{9}$/','paypwd','phonecode'],
        'edit_phone' => ['phone' => 'require|regex:/^1[3456789]\d{9}$/','phonecode'],
    ];
