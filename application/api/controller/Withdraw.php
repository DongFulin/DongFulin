...
class Withdraw extends Common{
    ...
    public function getWithdrawList(){
        ...
        foreach ($txmxres as $k => $v){
            $txmxres[$k]['type_name'] = get_withdraw_type_name($v['type']);
        }
