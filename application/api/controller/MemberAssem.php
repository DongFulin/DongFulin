...
class MemberAssem extends Common{
    ...
    public function info(){
        ...
        $goodsinfo['thumb_url'] = url_format($goodsinfo['thumb_url'],$webconfig['weburl'],'?imageMogr2/thumbnail/350x350');
    ...
    public function yaoqing(){
        ...
        $value = array('status'=>200,'mess'=>'获取拼团邀请信息成功','data'=>array('member_assem'=>$member_assem,'num'=>$num,'goods_name'=>$goods_name,'goods_id'=>$goodsId,'pin_number'=>$pin_number,'weburl'=>$weburl));
