...
//        $this->user_id = session('user_id');
	...
	* @description: 会员积分
	* @Author: lxb
	* @param : $userId:用户id;$num:积分;$type:1每日登录,2邀请注册,3完善信息（绑定手机）,4完善信息（上传头像）,5观看直播（30min）,6直播发言（次）,7直播分享（次）,8购物消费（%）,9订单评价（次）,10商品分享,11连续签到奖励,12普通签到奖励,13积分兑换,11连续签到奖励,12普通签到奖励
	* @return: json
	*/
